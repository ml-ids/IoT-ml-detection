...
# Accuracy plot
acc_plot = results_df.pivot(index="Model", columns="Balance", values="Accuracy").plot(kind='bar', ax=axes[0])
...
# Precision plot
prec_plot = results_df.pivot(index="Model", columns="Balance", values="Precision").plot(kind='bar', ax=axes[1])
...
# F1-Score plot
f1_plot = results_df.pivot(index="Model", columns="Balance", values="F1-Score").plot(kind='bar', ax=axes[2])
